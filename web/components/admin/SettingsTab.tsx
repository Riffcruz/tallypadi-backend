...
import { Shield, AlertTriangle, MessageSquare, Users, Save, Loader2 } from 'lucide-react';
        ...
        <div className="max-w-xl mx-auto space-y-6 animate-in fade-in duration-300">
            <div className="bg-slate-800 p-8 rounded-2xl border border-slate-700 shadow-lg">
                ...
                <h2 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                    <Shield className="text-blue-400" /> System Limits & Security
                </h2>
                ...
                <button 
                    onClick={handleSave} 
                    disabled={saving}
                    className="w-full mt-8 bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded-xl transition-colors flex justify-center items-center gap-2 disabled:opacity-50"
                >
