...
import { ShoppingBag, Phone, Loader2, PackageX, ExternalLink, AlertTriangle, Search, Menu } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 flex">
       ...
       <div className="flex-1 flex flex-col md:pl-64 min-w-0">
          {/* Mobile Navbar */}
          <header className="md:hidden bg-white border-b border-slate-200 p-4 flex items-center gap-4 sticky top-0 z-50">
             <button 
          ...
          {initialShop.planExpired && (
           ...
           {/* STICKY FILTER BAR */}
           <div className="sticky top-16 md:top-0 z-40 bg-white/80 backdrop-blur-md border-b border-slate-200 shadow-sm transition-all">
