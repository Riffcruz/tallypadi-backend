      ...
      <main className="pt-24">
        <section className="bg-white border-b border-slate-200">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-20">
            ...
            <h1 className="mt-6 text-4xl sm:text-5xl font-black tracking-tight text-slate-950">Terms of Service</h1>
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-6">
          <div className="rounded-lg border border-slate-200 bg-white p-6">
            <h2 className="text-xl font-black text-slate-950">Business identity and contact</h2>
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-6">
            ...
            <h2 className="mt-5 text-xl font-black text-slate-950">Advertising platform use</h2>
            <p className="mt-3 leading-7 text-slate-600">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="rounded-lg border border-slate-200 bg-white p-5">
              ...
              <h3 className="mt-4 font-black text-slate-950">Campaign controls</h3>
              <p className="mt-2 text-sm leading-6 text-slate-600">Merchants may request campaign pause, stop, top-up, resume, or change requests where available. Admin approval may be required to protect budgets and platform policy compliance.</p>
            </div>
            <div className="rounded-lg border border-slate-200 bg-white p-5">
              <AlertTriangle className="text-amber-600" size={24} />
              <h3 className="mt-4 font-black text-slate-950">No guaranteed results</h3>
              <p className="mt-2 text-sm leading-6 text-slate-600">Campaign approval, reach, clicks, conversions, sales, spend pace, and reporting availability can vary by provider, product category, budget, creative quality, and platform review.</p>
            </div>
          </div>
